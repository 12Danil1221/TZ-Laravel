...
" rel="stylesheet">
      ...
      <header class="bg-gray-50 ">
          <div class="container mx-auto">
              <div class="flex flex-wrap justify-between pt-5 pb-5">
                  <a href="/">
                  ...
                  <div class="flex mt-2 items-center">
                      ...
                      <input class="border-1 rounded-r-md" type="search">
                  </div>
                  <div class="flex mt-2 items-center">
                      ...
                      <a class="nav-link active" href="/profile/?{{ $_COOKIE['user_id'] }}">
                          <svg xmlns="http://www.w3.org/2000/svg" width="25px" height="25px" viewBox="0 0 24 24"
                              fill="none">
          ...
          <div class="container mx-auto">
              <div class="flex justify-between">
                  ...
                  <nav class="nav gap-4 flex justify-center flex-wrap pb-2">
                      ...
                      <li class="nav-item list-none">
                          <a class="nav-link disabled" href="{{ route('login') }}">Вход</a>
                      </li>
                      @endif
                      @if(isset($_COOKIE['user_id']))
                      <li class="nav-item list-none">
                      ...
                      <li class="nav-item list-none">
                          <a class="nav-link active" href="/blog-all">Блог</a>
                      </li>
                      @endif
                  </nav>
                  <div class="flex">
